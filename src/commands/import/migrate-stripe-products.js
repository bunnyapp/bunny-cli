...
function transformToImportFormat(stripeData) {
...
const migrateStripeProducts = new Command("migrate-stripe")
  ...
  .action(async (options) => {
    ...
    try {
      ...
      const bunnyData = transformToImportFormat(stripeData);
      ...
      const importCmd = await import("./products.js");
      await importCmd.default.parseAsync([
        "node",
        "bunny",
        "-f",
        bunnyDataPath,
